...
This project demonstrates the usage of Bazel to retrieve dependencies from `pip` repositories that includes basic New Relic instrumentation with best practices.
